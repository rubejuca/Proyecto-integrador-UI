                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form @submit.prevent="onSubmit">
                                        <div class="d-flex align-items-center mb-3 pb-1">
                                            ...
                                            <span class="h1 fw-bold mb-0">Restore password</span>
                                        </div>
      ...
      <div class="container-form" >
        <div class="information">
          <div class="info-childs">
            ...
            <p>Para iniciar sesión con tu nueva contraseña</p>
            <button class="info-childs-input" @click="changeForm('LOGIN')">Regresar</button>
        ...
        <div class="form-information">
          <div class="form-information-childs">
            <h2 class="bn-iniciar">Recuperar contraseña</h2>
          
            <p>Usa el correo que tienes registrado </p>
            <br>
            <form @submit.prevent="onSubmit">
              <div>
                <label class="btn-c">
              ...
              <div >
                <button @click="onSubmit" type="submit" class="btn-registrarse">Enviar</button>&nbsp;       
              </div>
...
import { doRecover } from '@/utils/firebase';
    ...
    setup() {
        ...
        const onSubmit = async () => {
            try {
                ...
                const response = await doRecover(email);
                console.log(response);
                // Muestra un SweetAlert cuando el correo se envía exitosamente
                Swal.fire({
                    icon: 'success',
                ...
                console.log(error);
                // Muestra un SweetAlert cuando ocurre un error al enviar el correo
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'Ha ocurrido un error al enviar el correo electrónico. Por favor, intenta de nuevo.'
                });
            }
        }
